...
import 'package:team_project_5_2/vm/database_handler.dart';
...
class _HqDocumentState extends State<HqDocument> {
  ...
  // addDocumentList(){
  //   documentList.add(Document(code: Get.arguments[0], propser: Get.arguments[1], title: Get.arguments[2], contents: Get.arguments[3], date: Get.arguments[4], type: Get.arguments[5], grade:Get.arguments[6]));
  // }
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '기안 날짜 : ${documentList[0].date.toString().substring(0, 10)}',
                  ),
                  Text(
